...
If we visualize light (energy, consciousness) going through the cycle of expanding and contracting to the centerpoint, we can watch vortexes forming, going through the center point of unity. This unity connection entangles the fractal, and connects it's entanglement to higher and lower fractals of itself. 

In this **unity experience**, you are now floating around a greater toroidal consciousness, again seeking unity. This greater toroidal consciousness, or bigger bubble, is made up of a bunch of bubbles which all are the completion of the previous level via a different experience of finding unity. Imagine each bubble as a star in a galaxy.

A **density contains all of the information of all of the densities it contains**, and the **lower density always has access to the higher densities information**, through a central core, which is the root of the fractal expression.

As we go through each density, **imagine what the core and the expansion represents**.

## Grouping Densities
Let’s first look at the groups of densities.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM5ODQzMjAwNCwzMzUxNjU1OTAsLTM3Mj
g2MTg2MiwxMjI0MjIwODM4LDIwMjA4ODU2MDYsLTE3MzQ4MzIz
OSwtMTk5NzQ0Nzg5NywtNTM0MzY5MDgxLC0zNDI5ODE5MDEsLT
Y2MTIxNTQ4MSwtOTkwOTkyMjM5LC0xOTU0NjI0NjA1XX0=
-->
